  ...
  return (
    <div>
      <div className="p-[20px] grid lg:grid-cols-4 gap-2 md:grid-cols-2 sm:grid-cols-1">
        ...
        <div onClick={() => navigate("/cart")} className="fixed right-4 bottom-4 border-2 h-[60px] w-[60px] flex justify-center items-center border-blue-600 hover:bg-blue-100 rounded-[10px] cursor-pointer">
          <ShoppingCartIcon
            sx={{ fontSize: 40 }}
